  ...
  ● Console
    ...
    console.error
      Error: Uncaught [Error: useTheme must be used within a ThemeProvider]
          ...
          at /workspaces/jg_aitraining2/packages/frontend/src/theme/ThemeProvider.test.js:75:24
          ...
          at Object.<anonymous> (/workspaces/jg_aitraining2/packages/frontend/src/theme/ThemeProvider.test.js:75:46)
          ...
          at BrokenConsumer (/workspaces/jg_aitraining2/packages/frontend/src/theme/ThemeProvider.test.js:73:22)
      ...
      73 |       return useTheme();
      74 |     };
    > 75 |     expect(() => render(<BrokenConsumer />)).toThrow(/useTheme must be used within a ThemeProvider/);
         |                        ^
      76 |   });
      77 |
      78 |   test('sets theme from localStorage', () => {
      ...
      at src/theme/ThemeProvider.test.js:75:24
      ...
      at Object.<anonymous> (src/theme/ThemeProvider.test.js:75:46)
...
Summary of all failing tests
 FAIL  src/__tests__/App.coverage.test.js
  ● Test suite failed to run
    ...
    SyntaxError: /workspaces/jg_aitraining2/packages/frontend/src/__tests__/App.coverage.test.js: Invalid left-hand side in assignment expression. (89:4)

      87 |     await titleInput.focus();
      88 |     await titleInput.setSelectionRange(0, 0);
    > 89 |     await titleInput.value = 'Test Task';
         |     ^
      90 |     const submitButton = screen.getByRole('button', { name: /add task/i });
      91 |     await submitButton.click();
      92 |     // Wait for task to appear
      ...
      at FlowParserMixin.checkLVal (../../node_modules/@babel/parser/src/parser/lval.ts:679:12)
      at FlowParserMixin.parseMaybeAssign (../../node_modules/@babel/parser/src/parser/expression.ts:335:12)
      at FlowParserMixin.parseMaybeAssign (../../node_modules/@babel/parser/src/plugins/flow/index.ts:3097:20)
      at FlowParserMixin.parseExpressionBase (../../node_modules/@babel/parser/src/parser/expression.ts:221:23)
      at callback (../../node_modules/@babel/parser/src/parser/expression.ts:212:39)
      at FlowParserMixin.allowInAnd (../../node_modules/@babel/parser/src/parser/expression.ts:3131:16)
      at FlowParserMixin.parseExpression (../../node_modules/@babel/parser/src/parser/expression.ts:212:17)
      at FlowParserMixin.parseStatementContent (../../node_modules/@babel/parser/src/parser/statement.ts:654:23)
